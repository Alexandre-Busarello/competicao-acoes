  ...
  async getOrCreateCheckpoint(): Promise<CheckpointData> {
    ...
    if (existing) {
      return {
        ...
        monthlyRankings: existing.monthlyRankings as RankingEntryForStorage[] | undefined,
        annualRankings: existing.annualRankings as RankingEntryForStorage[] | undefined,
